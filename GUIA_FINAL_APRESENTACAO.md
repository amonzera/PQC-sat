...
| `TRANSMIT` | “Todo enlace tem um trecho de risco; agora acompanhe a volta.” | “O que mudou quando o alerta apareceu?” | evento obrigatório, vetor single-bit reproduzível e causa oculta | ida e volta amarelas; ondas, distorção, partículas e alerta surgem somente no centro da volta | “A falha é injetada por software; amarelo marca o trecho e vermelho marca o evento.” | “Observamos radiação real” ou “o alerta prova a causa.” |
...
| `SELECT_RESPONSE` | “Escolha o que o sistema deveria fazer com este pacote.” | “Aceitar, retransmitir ou pedir modo seguro?” | decisão operacional condicionada à verificação | as três opções permanecem disponíveis; aceitar será avaliado como erro | “A interface permite a escolha para mostrar sua consequência, sem mudar o resultado da verificação.” | “Modo seguro é uma política universal” ou “retry garante disponibilidade.” |
...
| `DEBRIEF` | “Agora podemos revelar o resultado.” | “Seu diagnóstico e sua ação protegeram a missão?” | causa, diagnóstico e decisão operacional | causa, tecnologias, diagnóstico e ação surgem em sequência; CubeSat feliz ou explosão didática encerram | “O final exige diagnóstico e ação corretos; não prova causalidade física.” | “Um acerto prova causalidade física” ou “a demo vira resultado oficial.” |
...
No debrief, conduza os quatro blocos nesta ordem: causa revelada; tecnologias;
diagnóstico escolhido versus causa; ação escolhida. O CubeSat só termina feliz
se diagnóstico e ação estiverem corretos. A explosão é didática e não representa
um resultado físico observado.
